...
abstract class BaseTag extends BaseObject  implements Persistent {
  ...
  const PEER = 'TagPeer';
	...
	/**
	 * Set the value of [nb] column.
	 * 
	 * @param      int $v new value
	 * @return     Tag The current object (for fluent API support)
	 */
	public function setNb($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->nb !== $v) {
			$this->nb = $v;
			$this->modifiedColumns[] = TagPeer::NB;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->nb = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setNb($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TagPeer::NB)) $criteria->add(TagPeer::NB, $this->nb);
	 ...
	 * related ArticleTags from storage. If this Tag is new, it will return
		...
		if ($this->collArticleTags === null) {
			if ($this->isNew()) {
			   $this->collArticleTags = array();
				...
				$criteria->add(ArticleTagPeer::TAG_ID, $this->id);
	 ...
	 */
	public function getArticleTagsJoinArticle($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TagPeer::DATABASE_NAME);
		}
		...
		if ($this->collArticleTags === null) {
			if ($this->isNew()) {
				...
				$this->collArticleTags = ArticleTagPeer::doSelectJoinArticle($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
