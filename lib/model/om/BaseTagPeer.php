...
abstract class BaseTagPeer {
	...
	/** the column name for the NB field */
	const NB = 'tag.NB';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Slug', 'Nb', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'slug', 'nb', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::SLUG, self::NB, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'slug', 'nb', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Slug' => 2, 'Nb' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'slug' => 2, 'nb' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::SLUG => 2, self::NB => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'slug' => 2, 'nb' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TagPeer::NB);
  ...
  static public function getUniqueColumnNames()
  {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(ArticleTagPeer::TAG_ID, $obj->getId());
