...
abstract class BaseArticle extends BaseObject  implements Persistent {
  ...
  const PEER = 'ArticlePeer';
	...
	/**
	 * The value for the viewednb field.
	 * @var        int
	 */
	protected $viewednb;

	/**
	 * The value for the comment_nb field.
	 * @var        int
	 */
	protected $comment_nb;

	/**
	 * The value for the isdraft field.
	 * @var        int
	 */
	protected $isdraft;
	...
	/**
	 * @var        array ArticleTag[] Collection to store aggregation of ArticleTag objects.
	 */
	protected $collArticleTags;

	/**
	 * @var        Criteria The criteria used to select the current contents of collArticleTags.
	 */
	private $lastArticleTagCriteria = null;
	...
	/**
	 * Get the [viewednb] column value.
	 * 
	 * @return     int
	 */
	public function getViewednb()
	{
		return $this->viewednb;
	}

	/**
	 * Get the [comment_nb] column value.
	 * 
	 * @return     int
	 */
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = ArticlePeer::USER_ID;
		}
	...
	/**
	 * Set the value of [viewednb] column.
	 * 
	 * @param      int $v new value
	 * @return     Article The current object (for fluent API support)
	 */
	public function setViewednb($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->viewednb !== $v) {
			$this->viewednb = $v;
			$this->modifiedColumns[] = ArticlePeer::VIEWEDNB;
		}
	...
	/**
	 * Set the value of [comment_nb] column.
	 * 
	 * @param      int $v new value
	 * @return     Article The current object (for fluent API support)
	 */
	public function setCommentNb($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->comment_nb !== $v) {
			$this->comment_nb = $v;
			$this->modifiedColumns[] = ArticlePeer::COMMENT_NB;
		}
	...
	/**
	 * Set the value of [isdraft] column.
	 * 
	 * @param      int $v new value
	 * @return     Article The current object (for fluent API support)
	 */
	public function setIsdraft($v)
	{
		...
		if ($this->isdraft !== $v) {
			$this->isdraft = $v;
			$this->modifiedColumns[] = ArticlePeer::ISDRAFT;
		}
	...
	public function setArchiveId($v)
	{
		...
		if ($this->archive_id !== $v) {
			$this->archive_id = $v;
			$this->modifiedColumns[] = ArticlePeer::ARCHIVE_ID;
		}
	...
	public function setPwd($v)
	{
		...
		if ($this->pwd !== $v) {
			$this->pwd = $v;
			$this->modifiedColumns[] = ArticlePeer::PWD;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->viewednb = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->comment_nb = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
			$this->isdraft = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			$this->archive_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			...
			return $startcol + 11; // 11 = ArticlePeer::NUM_COLUMNS - ArticlePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastArticleTagCriteria = null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 5:
				...
				break;
			case 6:
				return $this->getViewednb();
				break;
			case 7:
				return $this->getCommentNb();
				break;
			case 8:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getViewednb(),
			$keys[7] => $this->getCommentNb(),
			$keys[8] => $this->getIsdraft(),
			$keys[9] => $this->getArchiveId(),
			$keys[10] => $this->getPwd(),
		);
		return $result;
	}
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 5:
				...
				break;
			case 6:
				$this->setViewednb($value);
				break;
			case 7:
				$this->setCommentNb($value);
				break;
			case 8:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setViewednb($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setCommentNb($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setIsdraft($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setArchiveId($arr[$keys[9]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticlePeer::USER_ID)) $criteria->add(ArticlePeer::USER_ID, $this->user_id);
		...
		if ($this->isColumnModified(ArticlePeer::VIEWEDNB)) $criteria->add(ArticlePeer::VIEWEDNB, $this->viewednb);
		if ($this->isColumnModified(ArticlePeer::COMMENT_NB)) $criteria->add(ArticlePeer::COMMENT_NB, $this->comment_nb);
		if ($this->isColumnModified(ArticlePeer::ISDRAFT)) $criteria->add(ArticlePeer::ISDRAFT, $this->isdraft);
		if ($this->isColumnModified(ArticlePeer::ARCHIVE_ID)) $criteria->add(ArticlePeer::ARCHIVE_ID, $this->archive_id);
		if ($this->isColumnModified(ArticlePeer::PWD)) $criteria->add(ArticlePeer::PWD, $this->pwd);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setViewednb($this->viewednb);

		$copyObj->setCommentNb($this->comment_nb);

		$copyObj->setIsdraft($this->isdraft);
	...
	/**
	 * Clears out the collArticleTags collection (array).
	 *
	...
	/**
	 * Initializes the collArticleTags collection (array).
	 *
	...
	/**
	 * Gets an array of ArticleTag objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Article has previously been saved, it will retrieve
	 * related ArticleTags from storage. If this Article is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getArticleTags($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		}
		...
		if ($this->collArticleTags === null) {
			if ($this->isNew()) {
			   $this->collArticleTags = array();
				...
				$criteria->add(ArticleTagPeer::ARTICLE_ID, $this->id);
	 ...
	 * @throws     PropelException
	 */
	public function countArticleTags(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collArticleTags === null) {
			if ($this->isNew()) {
				...
				$count = ArticleTagPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastArticleTagCriteria) || !$this->lastArticleTagCriteria->equals($criteria)) {
					...
					$count = count($this->collArticleTags);
				}
			} else {
				$count = count($this->collArticleTags);
			}
	...
	/**
	 * Method called to associate a ArticleTag object to this object
	 * through the ArticleTag foreign key attribute.
	 *
	 * @param      ArticleTag $l ArticleTag
	 * @return     void
	 * @throws     PropelException
	 */
	public function addArticleTag(ArticleTag $l)
	{
		...
		if (!in_array($l, $this->collArticleTags, true)) { // only add it if the **same** object is not already associated
			array_push($this->collArticleTags, $l);
			$l->setArticle($this);
		}
	}
	 ...
	 */
	public function getArticleTagsJoinTag($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(ArticlePeer::DATABASE_NAME);
		}
		...
		if ($this->collArticleTags === null) {
			if ($this->isNew()) {
				...
				$this->collArticleTags = ArticleTagPeer::doSelectJoinTag($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collArticleTags) {
				foreach ((array) $this->collArticleTags as $o) {
