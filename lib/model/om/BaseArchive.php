...
abstract class BaseArchive extends BaseObject  implements Persistent {
  ...
  const PEER = 'ArchivePeer';
	...
	public function setMonth($v)
	{
		...
		if ($this->month !== $v) {
			$this->month = $v;
			$this->modifiedColumns[] = ArchivePeer::MONTH;
		}
	...
	public function setNb($v)
	{
		...
		if ($this->nb !== $v) {
			$this->nb = $v;
			$this->modifiedColumns[] = ArchivePeer::NB;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->month = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = ArchivePeer::NUM_COLUMNS - ArchivePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArchivePeer::MONTH)) $criteria->add(ArchivePeer::MONTH, $this->month);
		if ($this->isColumnModified(ArchivePeer::NB)) $criteria->add(ArchivePeer::NB, $this->nb);
