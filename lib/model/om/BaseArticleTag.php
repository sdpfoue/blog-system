 ...
 */
abstract class BaseArticleTag extends BaseObject  implements Persistent {


  const PEER = 'ArticleTagPeer';
	...
	/**
	 * Initializes internal state of BaseArticleTag object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ArticleTag The current object (for fluent API support)
	 */
	public function setTagId($v)
	{
		...
		if ($this->tag_id !== $v) {
			$this->tag_id = $v;
			$this->modifiedColumns[] = ArticleTagPeer::TAG_ID;
		}
	...
	public function setArticleId($v)
	{
		...
		if ($this->article_id !== $v) {
			$this->article_id = $v;
			$this->modifiedColumns[] = ArticleTagPeer::ARTICLE_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = ArticleTagPeer::NUM_COLUMNS - ArticleTagPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ArticleTag object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ArticleTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseArticleTag:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			ArticleTagPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseArticleTag:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseArticleTag:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseArticleTag:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ArticleTagPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ArticleTagPeer::doInsert($this, $con);
					...
					$affectedRows += ArticleTagPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ArticleTagPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ArticleTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ArticleTagPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ArticleTagPeer::TAG_ID)) $criteria->add(ArticleTagPeer::TAG_ID, $this->tag_id);
		if ($this->isColumnModified(ArticleTagPeer::ARTICLE_ID)) $criteria->add(ArticleTagPeer::ARTICLE_ID, $this->article_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ArticleTagPeer::TAG_ID, $this->tag_id);
		$criteria->add(ArticleTagPeer::ARTICLE_ID, $this->article_id);
	 ...
	 *
	 * @return     ArticleTagPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ArticleTagPeer();
		}
		return self::$peer;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseArticleTag:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseArticleTag::%s', $method));
    }
